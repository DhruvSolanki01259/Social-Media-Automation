...
const CreatePost = () => {
  ...
  const renderSuggestions = (field, suggestions) => (
    <div className="absolute bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg mt-1 shadow-lg w-full z-50 max-h-48 overflow-auto">
      {suggestions.map((s, i) => (
        <div
          key={i}
          className={`px-3 py-2 text-sm cursor-pointer ${
            activeSuggestion === i
              ? "bg-[#2A6F97] text-white"
              : "text-[#013A63] dark:text-[#CBE5F5] hover:bg-gray-100 dark:hover:bg-gray-700"
          }`}
          onClick={() => handleSuggestionSelect(field, s)}
        >
          {s}
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl bg-white dark:bg-gray-800 border border-[#E2E8F0] dark:border-gray-700 shadow-lg rounded-2xl p-6 sm:p-8 overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mb-4">
            ...
            <div
              className={`border-2 border-dashed rounded-lg p-6 flex flex-col items-center justify-center cursor-pointer transition-all hover:border-[#2A6F97] hover:bg-[#F1F5F9] dark:hover:bg-gray-700 relative`}
            >
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                {mediaFiles.map((file, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="relative w-24 h-24 border border-[#E2E8F0] dark:border-gray-700 rounded-lg overflow-hidden"
                    >
                      {isImage ? (
                        <img
                          src={URL.createObjectURL(file)}
          ...
          <div className="relative" ref={titleRef}>
            ...
            <div className="relative">
              <input
                ...
                onKeyDown={(e) => handleKeyDown(e, "title")}
                className="w-full border border-[#E2E8F0] dark:border-gray-700 rounded-lg px-4 py-2.5 text-[#013A63] dark:text-[#CBE5F5] bg-[#F9FAFB] dark:bg-gray-700 focus:ring-2 focus:ring-[#2A6F97] focus:border-[#2A6F97]"
              />
              {formData.title && (
                <button
                  type="button"
                  onClick={() => handleClearInput("title")}
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-300 hover:text-gray-600 dark:hover:text-white"
                >
                  <X size={16} />
                </button>
              )}
          ...
          {/* Description */}
          <div className="relative" ref={captionRef}>
            <label className="block text-sm text-[#6C757D] dark:text-[#89A0B2] mb-2">
              Description
            </label>
            <div className="relative">
          ...
          <div className="mb-2">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              <input
                ...
                onKeyDown={handleTagKeyDown}
                placeholder="Press Enter to add tag"
                className="flex-1 min-w-[120px] px-3 py-1 rounded-xl border border-[#E2E8F0] dark:border-gray-700 bg-[#F9FAFB] dark:bg-gray-700 text-[#013A63] dark:text-[#CBE5F5] focus:ring-2 focus:ring-[#2A6F97] outline-none"
              />
            </div>
          </div>
